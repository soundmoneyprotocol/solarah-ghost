 ...
 */
function generateDecoratorNode({nodeType, properties = [], version = 1}) {
...
class SignupNode extends generateDecoratorNode({nodeType: 'signup',
    properties: [
        {name: 'alignment', default: 'left'},
        ...
        `<a href=${url} class=${postWrapperClass}>
            ...
            : ''}
                <div class="kg-collection-card-content">
                    ...
                    <div class=${metaClass}>
                        ${publishDate ? `<p>${luxon.DateTime.fromISO(publishDate).toFormat('d LLL yyyy')}</p>` : ''}
...
class CollectionNode extends generateDecoratorNode({nodeType: 'collection',
    properties: [
...
const extendedTextNodeReplacement = {replace: lexical.TextNode, with: node => new ExtendedTextNode(node.__text)};
...
const extendedHeadingNodeReplacement = {replace: richText.HeadingNode, with: node => new ExtendedHeadingNode(node.__tag)};

class ExtendedHeadingNode extends richText.HeadingNode {
    constructor(tag, key) {
        super(tag, key);
    }
    ...
    static importDOM() {
        const importers = richText.HeadingNode.importDOM();
        return {
            ...importers,
    ...
    static importJSON(serializedNode) {
        return richText.HeadingNode.importJSON(serializedNode);
    }
...
const extendedQuoteNodeReplacement = {replace: richText.QuoteNode, with: () => new ExtendedQuoteNode()};

class ExtendedQuoteNode extends richText.QuoteNode {
    constructor(key) {
        super(key);
    }
    ...
    static importDOM() {
        const importers = richText.QuoteNode.importDOM();
        return {
            ...importers,
    ...
    static importJSON(serializedNode) {
        return richText.QuoteNode.importJSON(serializedNode);
    }
                    ...
                    childNodes.forEach((child) => {
                        if (lexical.$isParagraphNode(child)) {
                            if (newChildNodes.length > 0) {
                                newChildNodes.push(lexical.$createLineBreakNode());
                                newChildNodes.push(lexical.$createLineBreakNode());
                            }
...
class TKNode extends lexical.TextNode {
    static getType() {
        return 'tk';
    }
...
function $createTKNode(text) {
    return lexical.$applyNodeReplacement(new TKNode(text));
}
...
class AtLinkNode extends lexical.ElementNode {
...
function $createAtLinkNode(linkFormat) {
    return lexical.$applyNodeReplacement(new AtLinkNode(linkFormat));
}
...
class AtLinkSearchNode extends lexical.TextNode {
    __placeholder = null;
...
function $createAtLinkSearchNode(text = '', placeholder = null) {
    return lexical.$applyNodeReplacement(new AtLinkSearchNode(text, placeholder));
}
...
class ZWNJNode extends lexical.TextNode {
    static getType() {
        return 'zwnj';
    }
...
exports.$isAtLinkNode = $isAtLinkNode;
exports.$isAtLinkSearchNode = $isAtLinkSearchNode;
...
exports.AtLinkNode = AtLinkNode;
exports.AtLinkSearchNode = AtLinkSearchNode;
...
exports.ExtendedHeadingNode = ExtendedHeadingNode;
...
exports.extendedHeadingNodeReplacement = extendedHeadingNodeReplacement;
exports.extendedQuoteNodeReplacement = extendedQuoteNodeReplacement;
exports.extendedTextNodeReplacement = extendedTextNodeReplacement;
